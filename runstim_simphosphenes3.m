function runstim_simphosphenes3(Hnd)
...
LOG.fn = 'runstim_stimphosphenes3';
LOG.BG = grey;
LOG.Par = Par;
LOG.Times = Par.Times;
% LOG.Frame = frame;
...
while ~Par.ESC
    ...
    visualHeightResolution=randi([5 11]);%number of subdivisions in the image height
