function runstim_microstim_saccade_catch59(Hnd)
%Written by Xing 25/10/17
%Present 2 targets for 2-phosphene task. Many different electrode sets (each with 4 electrodes)
...
trialConds=[1 1 1 1 2 2 2 2;1:4 1:4];%trial conditions. Target conds in first row: for TB trials, 1: target is above; 2: target is below
