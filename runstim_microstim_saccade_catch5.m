function runstim_microstim_saccade_catch5(Hnd)
...
electrodeInd=2;%electrodes 37 and 38 (indices 12 & 13, respectively) on array 13
load('C:\Users\Xing\Lick\finalCurrentVals5','finalCurrentVals');%list of current amplitudes to deliver, including catch trials where current amplitude is 0 (50% of all trials)
switch electrodeInd
    case 12
