function runstim_microstim_saccade_catch27(Hnd)
...
%Set 1: electrodes 29, 38, 62, 40 (on arrays 12, 13, 15, 10, respectively)
...
load('C:\Users\Xing\Lick\currentThresholdChs4.mat');%increased threshold for electrode 51, array 10 from 48 to 108, adjusted thresholds on all 4 electrodes
...
%     end
    ...
    FIXT=300;
    setElectrodes=[49 8 37 51;29 38 62 40];%first row: set 1, LRTB; second row: set 2, LRTB
