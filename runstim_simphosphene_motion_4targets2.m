...
%         end
    ...
    lineResolution=randi([4 6]);%number of simulated phosphenes in the series
...
%         finalPixelCoords2=random('unid',floor(spacing/2),[1,numSimPhosphenes]);
        maxJitterSize=10;
        finalPixelCoords=finalPixelCoords+random('unid',maxJitterSize,[1,numSimPhosphenes]);%randomise position of phosphene within each 'pixel'
        finalPixelCoords2=random('unid',maxJitterSize,[1,numSimPhosphenes]);
    end
...
%     end
    ...
    dirName=cd;
    save(['C:\Users\Xing\Lick\motion_task_logs\',date,'_mot_4targperf.mat'],'behavResponse','performance')
