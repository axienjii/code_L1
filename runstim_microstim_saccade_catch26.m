function runstim_microstim_saccade_catch26(Hnd)
...
%Set 1: electrodes 29, 38, 62, 42 (on arrays 12, 13, 15, 10, respectively)
...
%     end
    ...
    FIXT=300;
    setElectrodes=[49 8 37 51;29 38 62 42];%first row: set 1, LRTB; second row: set 2, LRTB
