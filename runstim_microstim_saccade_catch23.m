function runstim_microstim_saccade_catch23(Hnd)
%Written by Xing 29/9/17
%Interleave LR and TB trials, 8 trials per subblock.
%Defines sets of electrodes (4 electrodes per set). 
%Set 1: electrodes 50, 55, 37, 51 (on arrays 13, 11, 13, 10, respectively)
