function runstim_microstim_saccade_catch13(Hnd)
...
%The present code, catch 12, uses stimulator.play. Additionally, the sync
...
bipolar=0;%set to 0 for monopolar stimulation, set to 1 for bipolar stimulation
