function runstim_microstim_saccade_catch25(Hnd)
%Written by Xing 4/10/17
...
%Set 1: electrodes 49, 8, 37, 51 (on arrays 13, 10, 13, 10, respectively)
...
load('C:\Users\Xing\Lick\currentThresholdChs3.mat');%increased threshold for electrode 51, array 10 from 48 to 108, adjusted thresholds on all 4 electrodes
...
%     setElectrodes=[50 55 32 57;25 8 63 42];%first row: set 1, LRTB; second row: set 2, LRTB
    setElectrodes=[49 8 37 51;25 8 63 42];%first row: set 1, LRTB; second row: set 2, LRTB
    setArrays=[13 10 13 10;12 10 15 13];
    setInd=1;
%     if set==2
%         diagonal=randi(2);
