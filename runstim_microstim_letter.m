...
load('C:\Users\Xing\Lick\currentThresholdChs85.mat');%increased threshold for electrode 51, array 10 from 48 to 108, adjusted thresholds on all 4 electrodes
...
%                 phospheneCol=[0 0 0];
    ...
    if Hit == 0 %subject kept fixation, display stimulus
        ...
        FIXT2=durIndividualPhosphene+300%adjust
        stimFlag2=1;
        stimOffFlag=1;
