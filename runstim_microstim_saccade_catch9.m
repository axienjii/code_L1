function runstim_microstim_saccade_catch9(Hnd)
%Written by Xing 25/8/17
%Delivers bipolar microstimulation, via two adjacent electrodes.
...
electrodeInd=9;%electrodes 37 and 38 (indices 12 & 13, respectively) on array 13
electrodeReturn=10;%electrode on which anodic-first 'return current' is delivered
...
currentInd=find(finalCurrentVals<=90);
...
%         disp(FIXT);
    ...
    if Hit == 0 %subject kept fixation, display stimulus
        ...
        elseif currentAmplitude>0
            ...
            stimulator.autoStim(electrodeReturn,waveform_id_Return) %Electrode #2 , Waveform #2
